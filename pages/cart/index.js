...
const Cart = () => {
  ...
  return (
    <>
      <Head>
        <title>Mi Cesta | MiTienda</title>
      </Head>
      <div className="container xl:max-w-screen-xl mx-auto py-12 px-6">
        {cartCount > 0 ? (
          <>
            <h2 className="text-4xl font-semibold">Tu cesta</h2>
          ...
          <>
            ...
            <p className="mt-1 text-xl">
              Mira nuestras zapatillas increíbles{' '}
              <Link href="/">
                <a className="text-red-500 underline">aquí!</a>
              </Link>
            </p>
          </>
        )}
        ...
        {cartCount > 0 ? (
          <div className="mt-12">
            ...
            <div className="flex flex-col items-end border-t py-4 mt-8">
              ...
              >
                {redirecting ? 'Redirigiendo...' : 'Pagar'}
              </button>
            </div>
          </div>
        ) : null}
